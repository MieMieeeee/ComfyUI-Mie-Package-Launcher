...
class LaunchControlsSection(QtWidgets.QWidget):
    ...
    def _setup_ui(self):
        ...
        self._port_edit = port_edit = QtWidgets.QLineEdit()
        ...
        attn_opts = [
            ...
            ("Kitchen Attention (官方内置)", "--use-ck-attention"),
        ...
        self._cpath_btn = cpath_btn = QtWidgets.QPushButton()
        ...
        self._dpi_sized_widgets = [
            ...
            (self._gpu_combo, "setMinimumWidth", 220),
