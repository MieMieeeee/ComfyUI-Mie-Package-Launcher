...
class WebuiPage(BasePage):
    ...
    def _setup_ui(self):
        ...
        self._port_edit_width_base = 60
        self._port_edit.setFixedWidth(self._px(self._port_edit_width_base))
        self._dpi_sized_widgets.append((self._port_edit, "setFixedWidth", self._port_edit_width_base))
        ...
        self._cpath_btn_width_base = 32
        self._cpath_btn.setFixedWidth(self._px(self._cpath_btn_width_base))
        self._dpi_sized_widgets.append((self._cpath_btn, "setFixedWidth", self._cpath_btn_width_base))
        try:
        ...
        self._btn_container_width_base = 180
        btn_container.setFixedWidth(self._px(self._btn_container_width_base))
        self._btn_container = btn_container
        self._dpi_sized_widgets.append((btn_container, "setFixedWidth", self._btn_container_width_base))
        ...
        self._btn_primary_min_height_base = 60
        self._btn_primary.setMinimumHeight(self._px(self._btn_primary_min_height_base))
        self._dpi_sized_widgets.append((self._btn_primary, "setMinimumHeight", self._btn_primary_min_height_base))
        ...
        self._btn_open_min_height_base = 40
        self._btn_open.setMinimumHeight(self._px(self._btn_open_min_height_base))
        self._dpi_sized_widgets.append((self._btn_open, "setMinimumHeight", self._btn_open_min_height_base))
        ...
        self._btn_update_min_height_base = 36
        self._btn_update.setMinimumHeight(self._px(self._btn_update_min_height_base))
        self._dpi_sized_widgets.append((self._btn_update, "setMinimumHeight", self._btn_update_min_height_base))
        ...
        self._btn_remove_min_height_base = 36
        self._btn_remove.setMinimumHeight(self._px(self._btn_remove_min_height_base))
        self._dpi_sized_widgets.append((self._btn_remove, "setMinimumHeight", self._btn_remove_min_height_base))
